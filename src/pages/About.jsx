...
const About = () => {
  return (
    <div >
        ...
        {/* Section 01 */}
        <section className='bg-richblack-800 pt-16'>
            <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between 
            gap-14 text-center text-white'>
            {/* <p className='text-xl font-inter text-richblack-500 font-bold'>About Us</p> */}
                ...
                translate-y-[30%] grid-cols-3 gap-1'>
        ...
        <StatsComponent/>
        {/* Section-05 */}
        <section className='my-24 mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white'>
            <LearningGrid/>
            <ContactUsForm/>
        </section>
